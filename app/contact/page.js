    ...
    return (
        ...
        <div className="relative min-h-screen w-full flex flex-col overflow-x-hidden">
            ...
            <div className="absolute bottom-11 left-2.5 z-0 max-w-[500px]">
                <h1 className="text-8xl bg-gradient-to-l from-[rgb(136,198,191)] via-[rgb(33,300,147)] to-[rgb(160,160,190)] bg-clip-text text-transparent"> nowhere but here </h1>
            </div>
            ...
            <div className="relative z-30 w-full max-w-[800px] mx-auto px-4 pt-20 mt-10">
                ...
                <div className="flex flex-col relative z-30 max-w-[800px] mx-auto px-0">
                    ...
                    <div className="flex flex-col sm:flex-row sm:gap-x-4 gap-y-4">
                        <a className="bg-gray-200 text-gray-800 text-center py-2 px-6 rounded-0xl w-fit">
                            jbrothbard@gmail.com
                        </a>
                        <a href="https://linkedin.com/in/johnrothbard" className="bg-gray-200 text-gray-800 text-center py-2 px-6 rounded-0xl w-fit hover:bg-gray-300 transition">
                            LinkedIn
                        </a>
                    </div>
                ...
                <div className="relative z-30 max-w-[800px] mx-auto px-0 py-8 flex flex-col md:flex-row gap-3 justify-left">
                    ...
                    <a
                        href="/"
                        className="flex-none block bg-blue-600 text-white text-center py-2 px-6 rounded-0xl w-full sm:w-[200px] hover:bg-blue-700 transition"
                    >
                        Home
                    </a>
