...
export default function Home() {
    ...
    return (
        ...
        style={{background: "var(--page-bg)"}}>
            ...
            {/*SHEEP*/}
            <div className="absolute bottom-0 left-0 w-[400px] h-[300px] z-1 opacity-20 lg:opacity-100">
            ...
            <div className="absolute bottom-11 left-2.5 z-0 max-w-[350px]">
                <h1 className="hidden lg:block text-8xl bg-gradient-to-l from-[rgb(136,198,191)] via-[rgb(33,300,147)] to-[rgb(160,160,190)] bg-clip-text text-transparent"> keeping busy </h1>
            </div>
